...
export default function Login() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    const storedUser = localStorage.getItem(username); // Get user data using the username
    ...
    if (parsedUser.password === password) {
      localStorage.setItem("userSession", JSON.stringify(parsedUser)); // Store session
